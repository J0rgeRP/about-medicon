const translations = {
  ...
  es: {
    ...
    // Privacy Page
    priv_badge: "Offline por diseño",
    privacy_summary_1_title: "Sin internet",
    privacy_summary_1_text: "Tus datos de salud se quedan en tu dispositivo.",
    privacy_summary_2_title: "Sin rastreo",
    privacy_summary_2_text: "Sin analíticas, anuncios ni perfiles de terceros.",
    privacy_summary_3_title: "Tu control",
    privacy_summary_3_text: "Exporta, elimina o conserva tus registros en local.",
...
export function initLanguage() {
  ...
  document.querySelectorAll('[data-i18n]').forEach(
      el => translations.en[el.getAttribute('data-i18n')] = el.innerHTML);
